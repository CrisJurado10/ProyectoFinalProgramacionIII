...
public class app extends JFrame {
    ...
    public void asignarPresupuestoGeneral() {
        if (!textFiedlPresupuestoTotal.getText().isEmpty()) {
    ...
    public void ingresarGasto() {
        if (!textFieldMontoGasto.getText().isEmpty() && !textFieldMontoGasto.getText().equals("0")) {
            ...
            JOptionPane.showMessageDialog(null, "Error. El monto esta vacio");
        }
    }
    ...
    public void mostrarTransaccionesCategoria() {
        String text = "";
        String categoria = comboBoxMostrarTransacciones.getSelectedItem().toString();
